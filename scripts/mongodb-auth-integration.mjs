...
function safeError(error) {
	if (
		...
		error.message.startsWith('MongoDB auth integration requires')
	) {
		return error.message;
	}
	return `MongoDB auth integration failed during ${activeStep}.`;
}
...
async function main() {
	...
	try {
		...
		activeStep = 'atomic registration';
		...
		try {
			activeStep = 'client and ClientSession cleanup';
